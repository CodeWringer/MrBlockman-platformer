...
var worldScale = 0.8; // Global var for scaling the game world, use steps of .1, else the game breaks, because uneven numbers won't work
var worldGravity = 600 * worldScale; // Default value
