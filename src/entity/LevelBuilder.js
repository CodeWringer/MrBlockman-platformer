...
/**
* Instantiates and manages levels. 
*/
Crafty.c("LevelBuilder", 
{
    ...
    lObject: [],   // List of all contained objects. 
    lBlock: [],    // List of solid blocks. 
    lRamp: [],     // List of solid ramps. 
    lClip: [],     // List of clip blocks.
    lEntity: [],   // List of entities. 
    lTrim: [],     // List of trim objects. 
    lCollision: [],// List of collision objects (IBlock, IRamp, etc.). 
    lIBlock: [],   // List of IBlock objects. 
    lIRamp: [],    // List of IRamp objects. 

    curLevel: -1,
    levelBounds: { x: -1, y: -1 }, // Last x and y tile index of the current level. 
    ...
    */
    combineBlocks: function()
    {
        ...
        //     if (objR != null && objR.has("IBlock") && objR.h == curIBlock.h) { // Assimilate block to the right. 
        //         curIBlock.w = curIBlock.w + objR.w;
        //         this.lCollision.splice(this.lCollision.indexOf(objR), 1);
        //         this.lIBlock.splice(this.lIBlock.indexOf(objR), 1);

        //         if (objR.isWallL)
        //             curIBlock.isWallL = true;
        //         if (objR.isWallR)
        //             curIBlock.isWallR = true;
        //         if (objR.isCeiling)
        //             curIBlock.isCeiling = true;
        //         if (objR.isFloor)
        //             curIBlock.isFloor = true;

        //         objR.destroy();
        //         objR = null;
        //         countRemoved++;
        //     }
        //     if (objB != null && objB.has("IBlock") && objB.w == curIBlock.w) { // Assimilate block below. 
        //         curIBlock.h = curIBlock.h + objB.h;
        //         this.lCollision.splice(this.lCollision.indexOf(objB), 1);
        //         this.lIBlock.splice(this.lIBlock.indexOf(objB), 1);
